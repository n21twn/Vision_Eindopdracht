...
SPLIT_DIR = os.path.join(BASE_DIR, "object_crops_split_binair")  # map met 2 klassen: rood / zwart
...
# --- Model opslaan ---
model.save(os.path.join(BASE_DIR, "poker_model_binair.keras"))
print("\nModel opgeslagen als poker_model_binair.keras")
